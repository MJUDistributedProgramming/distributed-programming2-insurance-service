    ...
    public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/api/users/customer/login","/api/users/employee/login" ,"/api/users/customer/signup", "/api/users/employee/signup","/swagger-ui/**", "/v3/api-docs/**", "/loadbalancer", "/actuator/prometheus", "/api/paymentInfo/getAllPaymentInfo", "/api/insurances/getAllInsurance", "/api/customers/retrieveCustomer").permitAll()
